                ...
                if (bytesRead > 0)
                {
                    ...
                    if (parts.Length == 2)
                    {
                        ...
                        // }
                         ...
                         // 250605. Update the avatar model from input data
                        ...
                        foreach (string l in lines)
                        {
                            ...
                            // string messageToShow = $"{i} : {s[1]}, {s[2]}, {s[3]}";
                            // UnityMainThreadDispatcher.Instance()?.Enqueue(() => UpdateDisplay(messageToShow, true));
